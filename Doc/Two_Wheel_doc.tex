...
$$\ddot p |_{\theta_y} = \frac{I_{p, \theta_y}}{I_{\theta_y}} * cos(\theta_y)$$
...
This controller can (with the right $K_p$ and $K_d$) mantain the vertical position but struggles with the controll of the position.
