...
B = simplify([diff(DE(1), u_ddot(1)), diff(DE(1), u_ddot(2)), diff(DE(1), u_ddot(3)); ...
    diff(DE(2), u_ddot(1)), diff(DE(2), u_ddot(2)), diff(DE(2), u_ddot(3)); ...
    diff(DE(3), u_ddot(1)), diff(DE(3), u_ddot(2)), diff(DE(3), u_ddot(3));]);
EL_latex = latex(EL);
...
B= [2*m_w+m_b+2*Gamma_w_yy/(r^2),   -l*m_b,            0;
   -l*m_b,                  Gamma_b_yy+l^2*m_b,     0;
